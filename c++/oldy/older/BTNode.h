...
class BTNode : public Node<E> {
	public:
		...
		bool isRoot() const;
	protected:
		BTNode<E> *_left, *_right, *_parent;
		int _height, _depth;
};

template <typename E>
BTNode<E>::BTNode() :
	Node<E>::Node(), _left(0), _right(0),
	_parent(0), _height(0), _depth(0)		
{}

template <typename E>
BTNode<E>::BTNode(const E &e) :
	Node<E>::Node(e), _left(0), _right(0),
	_parent(0), _height(0), _depth(0)
{}
...
template <typename E>
int BTNode<E>::height() const {
	return _height;
}

template <typename E>
int BTNode<E>::depth() const {
	return _depth;
}
